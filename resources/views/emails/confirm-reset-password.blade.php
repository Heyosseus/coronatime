...
<body style="background-color: #f6f6f6; font-family: Inter, sans-serif; font-size: 16px; line-height: 1.5em; margin: 0; padding: 0;">
...
<div style="background-color: #ffffff; margin: 40px auto; max-width: 600px; padding: 20px;">
    ...
    <h1 style="color: #444444; font-size: 24px; font-weight: bold; margin-bottom: 20px;
     margin-top: 14px; text-align: center">Confirmation Email</h1>
    ...
    font-size: 16px; margin-bottom: 20px; padding: 12px 20px; text-align: center; text-decoration: none;

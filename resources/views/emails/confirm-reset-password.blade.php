...
<div style="background-color: #ffffff; margin: 40px auto; max-width: 600px; padding: 20px;">
    <h1 style="color: #444444; font-size: 24px; font-weight: bold; margin-bottom: 20px; display:flex; align-items:center; justify-content: center;">Confirmation Email</h1>

    <p style="color: #444444; margin-bottom: 20px; text-align: center">click this button to verify your email</p>
    <div style="display:flex; align-items:center; justify-content: center;">
        <a href="{{ route('new_password') }}" style="background-color: #0FBA68; border: none; color: #ffffff; display: inline-block;

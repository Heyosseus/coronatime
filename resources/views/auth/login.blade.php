<x-layout>
    <div class="lg:px-12 ">
        ...
        <form action="{{route('post_login')}}" method="POST" class="flex flex-col px-6 lg:w-login-form ">
            ...
            <button type="submit"
                    class="bg-green-600 text-white p-3 mt-10 rounded hover:bg-blue-400 font-bold">@lang('login.login')</button>


            <p class="text-center py-8 flex justify-around">@lang('login.account')<a href="{{route('register')}}"
                                                                                     class="font-bold ">@lang('login.sign_up')</a>
            </p>
